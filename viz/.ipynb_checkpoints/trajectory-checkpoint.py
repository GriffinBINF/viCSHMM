...
def get_cell_color_map(adata, color_key):
...
def plot_cells_on_trajectory(
    ...
    plot_transitions=False, savepath=None
):
    """
    ...
    cell_colors_raw, get_color, is_continuous, color_info, norm = get_cell_color_map(adata, color_key)
    ...
    for cell_id, row in assignments.iterrows():
        ...
        if edge:
            ...
            cell_x.append(0)
            cell_y.append(0)
        val = cell_colors_raw.loc[cell_id]
